sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("jetCources/Project/app", ".html");
		...
		return Opa5.extend("jetCources.Project.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["jetCources/Project/localService/mockserver"], function (mockserver) {
